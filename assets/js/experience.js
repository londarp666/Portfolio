...
const exp = [
  {
    ...
    place: "PT Selamat Sempurna Tbk",
    time: "(March, 2023 - present)",
    desp: "<li>Worked to migrate PT Selamat Sempurna Tbk lite’s product page to AMP pages so that they load up instantly.</li> <li>Made changes in the current progressive web app of PT Selamat Sempurna Tbk to react to different actions performed on AMP page.</li> <li>Created a node module called “fk-amp” which abstracts all the files and middlewares and can be easily imported and used from express server.</li>",
  },
  {
  ...
  },
  {
    ...
    cardImage: "assets/images/experience-page/vienci.png",
    place: "Vienci Studio",
    time: "(Dec, 20 - Jan, 22)",
